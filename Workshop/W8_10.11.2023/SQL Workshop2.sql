...
SELECT customers.city, customers.contact_name,freight FROM orders
INNER JOIN customers ON orders.customer_id = customers.customer_id
WHERE freight >= 40
...
select o.order_date, o.order_id as "orderid",avg(od.unit_price) as "ortalama_fiyat" from orders o
...
INNER JOIN suppliers ON products.supplier_id = suppliers.supplier_id
inner join order_details on products.product_id = order_details.product_id
group by  categories.category_name, suppliers.company_name,products.product_id
